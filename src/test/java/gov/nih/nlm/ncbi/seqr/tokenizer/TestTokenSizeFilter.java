...
/**
 * Simple Tests to ensure this TokenSizeFilter is working
 */
public class TestTokenSizeFilter extends BaseTokenStreamTestCase {
    public void testTokenSizeFilter() throws IOException {

        TokenStream stream = new MockTokenizer(
                new StringReader("short too long"), MockTokenizer.WHITESPACE, false);
